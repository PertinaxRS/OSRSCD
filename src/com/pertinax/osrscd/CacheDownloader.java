package com.pertinax.osrscd;

import com.pertinax.osrscd.cache.FileStore;
import com.pertinax.osrscd.cache.ReferenceTable;
import com.pertinax.osrscd.net.CacheRequester;
import com.pertinax.osrscd.net.FileRequest;
import com.pertinax.osrscd.hash.Whirlpool;
...
public class CacheDownloader {
	...
	public static void main(String[] args) {
		try {
			CacheDownloader downloader = new CacheDownloader(args.length > 0 ? Integer.valueOf(args[0]) : Defaults.getWorldID(), args.length > 1 ? Integer.valueOf(args[1]) : Defaults.getRevision(), args.length > 2 ? Boolean.valueOf(args[2]) : Defaults.getFallback());
			downloader.run();
